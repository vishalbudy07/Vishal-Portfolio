...
const Projects: React.FC = () => {
  ...
  const projects = [
    ...
    // Removed E-commerce Web App Clone and added the new project below
    {
      title: 'Vishal Portfolio (This Project)',
      description: 'A modern, responsive portfolio built with React, TypeScript, and Tailwind CSS. Features dark/light theme, smooth animations, and a clean, accessible UI.',
      image: '🌐',
      techStack: ['React', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'Vite'],
      category: 'Frontend',
      github: 'https://github.com/vishalbudy07/Vishal-Portfolio.git',
      demo: 'https://vishalbudy07.github.io/Vishal-Portfolio/',
      featured: false,
    },
    // Removed "Portfolio Website v2 with 3D Animations" and added a new project below
    {
      title: 'Expense Tracker Progressive Web App',
      description: 'A cross-platform PWA for tracking daily expenses, visualizing spending habits, and exporting reports. Works offline and supports install to device.',
      image: '💸',
      techStack: ['React', 'TypeScript', 'IndexedDB', 'PWA', 'Chart.js'],
      category: 'Web App',
      github: 'https://github.com/vishalbudy07/expense-tracker-pwa',
